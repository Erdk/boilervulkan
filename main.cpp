...
VkResult CreateDebugUtilsMessengerEXT(VkInstance instance, const VkDebugUtilsMessengerCreateInfoEXT* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkDebugUtilsMessengerEXT* pCallback) {
  ...
  std::cout << "can't find vkCreateDebugUtilsMessengerEXT" << std::endl;
...
class HelloTriangleApplication {
  ...
  private:
    ...
    void createGraphicsPipeline() {
      ...
      rasterizer.rasterizerDiscardEnable = VK_FALSE; // <- /dev/null if set to true
      ...
      // color blending
      //
      // first one is per framebuffer, here dummy
...
//    }
    ...
    void createDescriptorPool() {
      ...
      poolSizes[0].descriptorCount = static_cast<size_t>(swapChainImages.size());
      poolSizes[1].type = VK_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER;
      poolSizes[1].descriptorCount = static_cast<size_t>(swapChainImages.size());
    ...
    static VKAPI_ATTR VkBool32 VKAPI_CALL debugCallback(VkDebugUtilsMessageSeverityFlagBitsEXT flags, VkDebugUtilsMessageTypeFlagsEXT messageType, const VkDebugUtilsMessengerCallbackDataEXT* pCallbackData, void* pUserData) {
